...
mixin _$HomeEntity {
 ...
 int get application; int get inProgress; int get complete;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeEntity&&(identical(other.application, application) || other.application == application)&&(identical(other.inProgress, inProgress) || other.inProgress == inProgress)&&(identical(other.complete, complete) || other.complete == complete));
}


@override
int get hashCode => Object.hash(runtimeType,application,inProgress,complete);

@override
String toString() {
  return 'HomeEntity(application: $application, inProgress: $inProgress, complete: $complete)';
}
...
@useResult
$Res call({
 int application, int inProgress, int complete
});
...
/// Create a copy of HomeEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? application = null,Object? inProgress = null,Object? complete = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int application,  int inProgress,  int complete)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeEntity() when $default != null:
return $default(_that.application,_that.inProgress,_that.complete);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int application,  int inProgress,  int complete)  $default,) {final _that = this;
switch (_that) {
case _HomeEntity():
return $default(_that.application,_that.inProgress,_that.complete);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int application,  int inProgress,  int complete)?  $default,) {final _that = this;
switch (_that) {
case _HomeEntity() when $default != null:
return $default(_that.application,_that.inProgress,_that.complete);case _:
  return null;
...
class _HomeEntity implements HomeEntity {
  const _HomeEntity({required this.application, required this.inProgress, required this.complete});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeEntity&&(identical(other.application, application) || other.application == application)&&(identical(other.inProgress, inProgress) || other.inProgress == inProgress)&&(identical(other.complete, complete) || other.complete == complete));
}
...
/// Create a copy of HomeEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? application = null,Object? inProgress = null,Object? complete = null,}) {
